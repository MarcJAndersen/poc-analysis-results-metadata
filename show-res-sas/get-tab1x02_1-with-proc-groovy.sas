...
m.read("../res-ttl/CDISC-pilot-TAB1X02_1.ttl") ;
        
// https://jena.apache.org/documentation/javadoc/arq/org/apache/jena/query/QueryFactory.html    
Query query = QueryFactory.read("../sparql-rq/tab1x02_1.rq") ;
...
FileOutputStream os = new FileOutputStream("check-CDISC-pilot-TAB1X02_1.xml");            
...
%sparqlreadxml(
    ...
    sparqlqueryresultxml=check-CDISC-pilot-TAB1X02_1.xml,
    frsxlemap=SXLEMAP,
    resultdsn=tab1x02_1,
    debug=Y
);
