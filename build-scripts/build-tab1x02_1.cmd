...
:build-gen-res
pushd ..\gen-res-sas
set targetfilecsv1=..\res-csv\tab1x02_1.csv
if exist %targetfilecsv1% del %targetfilecsv1%
set targetfilecsv2=..\res-csv\tab1x02_1-Components.csv
if exist %targetfilecsv2% del %targetfilecsv2%
%sascmd% tab1x02_1.sas
if %ERRORLEVEL% gtr 1 goto :stop
popd

:build-res-ttl
pushd ..\use-rrdfqbcrnd0
set targetfilettl=..\res-ttl\CDISC-pilot-tab1x02_1.ttl
if exist %targetfilettl% del %targetfilettl%
%Rcmd% -e "library(knitr); knit('tab1x02_1-ttl.Rmd')" 
popd

:build-show-res
pushd ..\show-res-sas
set prgsasgenhtml=get-tab1x02_1-with-proc-groovy.sas
set targetfilehtml=..\show-res-sas\tab1x02_1.html
