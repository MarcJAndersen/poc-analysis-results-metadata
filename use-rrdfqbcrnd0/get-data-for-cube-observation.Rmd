...
Here is the code for highlight with Latex for generating PDF - not working `{r ADSL-records-SELECT-query.rq, results='asis', engine='highlight', engine.path='/usr/bin/highlight', engine.opts='-S n3 --inline-css --out-format=latex -I'}`.
...
```{r ADSL-records-CONSTRUCT.rq, results='asis', engine='highlight', engine.path='/usr/bin/highlight', engine.opts='-S n3 --inline-css'}
...
```{r xADSL-records-observation.ttl, results='asis', engine='highlight', engine.path='/usr/bin/highlight', engine.opts='-S n3 --inline-css'}
